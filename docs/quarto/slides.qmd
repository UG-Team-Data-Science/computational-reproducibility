...
1. Open `visualizing_distributions_I.Rmd`
2. Click on `Knit`
...
## Immutable layers but the container layer
...
docker run -it -p 10000:8888 venustiano/fdvcw:27-12-25    #<4>
...
##
```bash
docker run -it -p 8888:8888 -v $(pwd):/home/jovyan/bind_folder venustiano/fdvcw:27-12-25
```
